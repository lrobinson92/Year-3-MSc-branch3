...
export const CHECK_DRIVE_AUTH_SUCCESS = 'CHECK_DRIVE_AUTH_SUCCESS';
export const CHECK_DRIVE_AUTH_FAIL = 'CHECK_DRIVE_AUTH_FAIL';
export const GOOGLE_DRIVE_AUTH_FAIL = 'GOOGLE_DRIVE_AUTH_FAIL';
...
export const IMPROVE_SOP_START = 'IMPROVE_SOP_START';
export const IMPROVE_SOP_SUCCESS = 'IMPROVE_SOP_SUCCESS';
export const IMPROVE_SOP_FAIL = 'IMPROVE_SOP_FAIL';
export const SUMMARIZE_SOP_START = 'SUMMARIZE_SOP_START';
export const SUMMARIZE_SOP_SUCCESS = 'SUMMARIZE_SOP_SUCCESS';
export const SUMMARIZE_SOP_FAIL = 'SUMMARIZE_SOP_FAIL';
export const CLEAR_SUMMARY = 'CLEAR_SUMMARY';
export const CLEAR_IMPROVED_CONTENT = 'CLEAR_IMPROVED_CONTENT';
export const CLEAR_DOCUMENT_ERROR = 'CLEAR_DOCUMENT_ERROR';